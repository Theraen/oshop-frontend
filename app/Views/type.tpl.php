  ...
  <section class="products-grid">
    <div class="container-fluid">
      ...
      <header class="product-grid-header d-flex align-items-center justify-content-between">
        <div class="mr-3 mb-3">
          Affichage <strong><?= $viewVars['nbProductInType']; ?> </strong>de <strong><?= $viewVars['nbAllProduct']['nbProduct']; ?> </strong>résultats
        </div>
      ...
      <div class="row">
        ...
        $category = $viewVars['category']->find($product->getCategoryId());
        ...
        <div class="product col-xl-3 col-lg-4 col-sm-6">
          ...
          <div class="py-2">
            <p class="text-muted text-sm mb-1"><?= $category->getName(); ?></p>
