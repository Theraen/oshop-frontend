        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <ul class="list-unstyled">
              <!-- Il va faloire faire un foreach -->
              <?php 
              foreach ($viewVars['footerTypes'] as $type):
                ?>
              <li><a href="<?= $router->generate('route_type', ['idType' => $type->getId()]); ?>" class="text-muted"><?= $type->getName(); ?></a></li>
              <?php
                endforeach;
              ?>
            </ul>
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <ul class="list-unstyled">
            <?php 
              foreach ($viewVars['footerBrand'] as $brand):
            ?>
              <li> <a href="<?= $router->generate('route_brand', ['idBrand' => $brand->getId()]); ?>" class="text-muted"><?= $brand->getName(); ?></a></li>
              <?php
                endforeach;
              ?>
            </ul>
